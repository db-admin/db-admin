...
3. Run `npm install`
4. Create a dba.config.json file at the root of this project. See the [example config file](https://github.com/db-admin/db-admin/blob/master/sample-dba.config.json) in this repository.
